...
const Input : React.FC<InputProps>= ({
    ...
    return (
        <div className="w-full relative">
            ...
            placeholder="" type = {type} className=
            {`peer 
            w-full 
            p-4 
            pt-6 
            ...
            left-3 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus: scale-75 peer-focus:-translate-y-4
