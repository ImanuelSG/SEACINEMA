...
<MovieClientButton path={`/${movie.id}/${dateAt11.getTime()}`} time="11:00" currentTime={date.getTime()} showTime={dateAt11.getTime()}/>
<MovieClientButton path={`/${movie.id}/${dateAt14.getTime()}`} time="14:00"currentTime={date.getTime()} showTime={dateAt14.getTime()}/>
<MovieClientButton path={`/${movie.id}/${dateAt17.getTime()}`} time="17:00" currentTime={date.getTime()} showTime={dateAt17.getTime()}/>
<MovieClientButton path={`/${movie.id}/${dateAt20.getTime()}`} time="20:00" currentTime={date.getTime()} showTime={dateAt20.getTime()}/>
